...
//         "http://192.168.1.112:8000/api/admin/get_winner/"
//       );
...
//         setTimeout(() => setShowConfetti(false), 10000000000); // Stop confetti after 5 seconds
//       }
//     } catch (error) {
...
//                   {index === totalCards - 1
//                     ? "¡Gane un Todoterreno!"
//                     : "Vale por ₡ 30 000 de gasolina"}
//                 </h1>

//                 {/* Show winner only if "Sortear" has been clicked */}
//                 {winners[index] ? (
//                   <>
...
//                 <button
//                   className="bg-white text-red-800 font-medium py-1 px-6 rounded-full"
