...
import {
  Users, Globe, Cpu, Palette, Sparkles, Code, Smartphone, Bot, Box, Video,
  Briefcase, SlidersHorizontal, TrendingUp, Megaphone, Mail, Phone, MapPin,
} from "lucide-react";
...
function WhoContent() {
  ...
  return (
    <div className="pb-6">
      <div className="mb-8">
        <p className="text-base md:text-lg font-semibold text-gray-900 font-dm-sans leading-snug">
          {t.whoBody}
        </p>
        <p className="text-sm text-gray-500 font-dm-sans leading-relaxed mt-3">
          {t.whoBody2}
        </p>
      </div>

      <div className="relative pl-8 md:pl-10">
        <div className="absolute left-[11px] md:left-[15px] top-2 bottom-2 w-px bg-gray-200" />

        {points.map((point, i) => {
          const Icon = point.icon;
          return (
            <div key={i} className="relative mb-8 last:mb-0">
              <div className="absolute -left-8 md:-left-10 top-0 w-[22px] h-[22px] md:w-[30px] md:h-[30px] rounded-full bg-white border-2 border-gray-200 flex items-center justify-center">
                <Icon size={12} strokeWidth={2} className="text-gray-900 md:hidden" />
                <Icon size={16} strokeWidth={2} className="text-gray-900 hidden md:block" />
              </div>
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-2">
            ...
            <button
              ...
              className="text-sm font-medium text-gray-900 hover:underline flex-shrink-0 mt-1"
            >
        ...
        <div className="space-y-5 mt-3">
          ...
          <div className="flex justify-around border-t border-b border-gray-100 py-4 my-2">
            <div className="text-center">
              ...
              <div className="text-[10px] text-gray-400 mt-0.5">{t.rating}</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-[10px] text-gray-400 mt-0.5">{t.downloads}</div>
            </div>
            <div className="w-px bg-gray-200" />
            <div className="text-center">
              <div className="text-sm font-semibold text-gray-900">
              ...
              <div className="text-[10px] text-gray-400 mt-0.5">{t.content}</div>
            </div>
          </div>
...
function ProjectsContent() {
  ...
  return (
    <div className="space-y-5 pb-6">
      <p className="text-sm md:text-base text-gray-500 font-dm-sans leading-relaxed">
        {t.projectsIntro}
      </p>
...
function ServiceCard({
  ...
  return (
    <div className="bg-white rounded-2xl p-4 md:p-5 flex flex-col items-center gap-2 text-center">
...
function ServicesContent() {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 pb-6">
      {services.map((item, i) => (
        <ServiceCard key={i} icon={item.icon} label={item.label} desc={item.desc} />
      ))}
    </div>
  );
}
        ...
        <div className="md:w-2/5 space-y-5">
          ...
          <div>
            ...
            <p className="flex items-start gap-2 text-sm font-semibold text-gray-900 mt-1">
              <MapPin size={16} strokeWidth={1.5} className="text-gray-500 flex-shrink-0 mt-0.5" />
          ...
          <div>
            ...
            <div className="flex gap-3 mt-2">
              {[
                { href: "https://www.instagram.com/josealejandroruiz_/", label: "Instagram", path: "M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4a5.8 5.8 0 0 1-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2m-.2 2A3.6 3.6 0 0 0 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8a3.6 3.6 0 0 0 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4H7.6m9.65 1.5a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5M12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10m0 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6z" },
                { href: "https://www.linkedin.com/in/alejandro-ruiz-a5622a278/", label: "LinkedIn", path: "M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.79M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z" },
                { href: "https://github.com/rouge2203", label: "GitHub", path: "M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0 1 12 6.844a9.59 9.59 0 0 1 2.504.338c1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.02 10.02 0 0 0 22 12.017C22 6.484 17.522 2 12 2z" },
              ].map((social, i) => (
                <a
                  key={i}
                  href={social.href}
        ...
        <div className="md:w-3/5 space-y-4">
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              ...
              <input
                ...
                className="mt-1 w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-gray-400 transition-colors font-dm-sans"
              />
            </div>
            <div className="flex-1">
              <label className="text-xs font-medium text-gray-500 uppercase tracking-wider">
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              className="mt-1 w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-gray-400 transition-colors resize-none font-dm-sans"
            />
          </div>
