  ...
  return (
    <div className="pb-6 space-y-8">
      <div className="px-2 md:px-4">
        <blockquote className="text-xl md:text-2xl font-bold text-gray-900 font-inter leading-snug tracking-[1.5px]">
          "{t.servicesQuote}"
        </blockquote>
        <p className="text-[11px] text-gray-400 font-inter mt-3 uppercase tracking-[2px]">
          — {t.servicesQuoteAuthor}
        </p>
        <p className="text-lg md:text-xl font-dm-serif text-gray-900 mt-6 italic">
          {t.servicesLetsStart}
        </p>
      </div>
