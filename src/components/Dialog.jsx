...
export default function DialogX({ open, setOpen }) {
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog className="relative z-20 animate-fade" onClose={setOpen}>
        <Transition.Child
          as={Fragment}
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-zinc-950 bg-opacity-80 transition-opacity backdrop-blur-2xl" />
        </Transition.Child>
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-xl bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    <Dialog.Title
                      as="h3"
                      className="text-base font-geomanist font-semibold leading-6 text-gray-900"
                    >
                    ...
                    <div className="mt-2">
                      ...
                      <div className="flex space-x-2 mt-2 items-center">
                        <PhoneIcon className="h-5 w-5 hover:cursor-pointer hover:text-gray-300" />
                        <a
                ...
                <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                  <button
                    type="button"
                    className="inline-flex w-full justify-center rounded-md bg-zinc-950 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:opacity-85 sm:ml-3 sm:w-auto"
